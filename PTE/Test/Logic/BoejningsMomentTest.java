...
public class BoejningsMomentTest {
	...
	public void getBoejningsMomentNormalFdimTest() {
		...
		assertEquals(100, boejningsMoment.getBoejningsMoment(laengdeRetning, laengde, dimensionerendeKraft, forskydningkraft), 0.001);
	}
	@Test
	public void getBoejningsMomentNormalFtTest() {
		...
		assertEquals(150, boejningsMoment.getBoejningsMoment(laengdeRetning, laengde, dimensionerendeKraft, forskydningkraft), 0.001);
	}
	@Test
	public void getBoejningsMomentKommatalFdimTest() {
		...
		assertEquals(505.556, boejningsMoment.getBoejningsMoment(laengdeRetning, laengde, dimensionerendeKraft, forskydningkraft), 0.001);
	}
	@Test
